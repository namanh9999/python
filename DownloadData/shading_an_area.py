...
def draw_pyplot(data_high, data_low, dates):
    ...
    # shading 
    # alpha to control transparency of color
    plt.plot(dates, data_high, c= "Green", alpha=0.5)
    plt.plot(dates, data_low, c= "Red", alpha=0.5)
    plt.fill_between(dates, data_high, data_low, facecolor="Gray",
                    alpha = 0.4)
